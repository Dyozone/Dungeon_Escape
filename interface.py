...
class Game:
    ...
    def start_menu():
        ...
        pygame.draw.rect(screen, 'white', start_button.rect, 6)
        screen.blit(start_button.font.render(start_button.content, True, start_button.bg, start_button.fg),
                    (start_button.x + 20, start_button.y))
        pygame.draw.rect(screen, 'white', quit_button.rect, 6)
        screen.blit(quit_button.font.render(quit_button.content, True, quit_button.bg, quit_button.fg),
    ...
    def pause_menu():
        ...
        quit_button = Button(Display.WIDTH - 130, screen.get_rect().centery, 120, 50, 'white', 'black', 'Quit', 32)
        pygame.draw.rect(screen, 'white', continue_button.rect, 6)
        screen.blit(continue_button.font.render(continue_button.content, True, continue_button.bg, continue_button.fg),
                    (continue_button.x + 20, continue_button.y))
        pygame.draw.rect(screen, 'white', quit_button.rect, 6)
        screen.blit(quit_button.font.render(quit_button.content, True, quit_button.bg, quit_button.fg),
                    (quit_button.x + 40, quit_button.y))
    ...
    def over_menu():
        ...
        quit_button = Button(Display.WIDTH - 130, screen.get_rect().centery, 120, 50, 'white', 'black', 'Quit', 32)
        pygame.draw.rect(screen, 'white', restart_button.rect, 6)
        screen.blit(restart_button.font.render(restart_button.content, True, restart_button.bg, restart_button.fg),
    ...
    def victory_menu():
        ...
        screen.blit(quit_button.font.render(quit_button.content, True, quit_button.bg, quit_button.fg),
                    (quit_button.x + 40, quit_button.y))
        pygame.draw.rect(screen, 'white', text_box.rect, 6)
        screen.blit(quit_button.font.render(text_box.content, True, text_box.bg, text_box.fg),
